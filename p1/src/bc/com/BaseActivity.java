...
//		Controller1.getConller1().addListener(this);
	...
	private Dialog showMessageDialog() {
		View mView = LayoutInflater.from(context).inflate(R.layout.sms_dialog, null);
		TextView v = (TextView) mView.findViewById(R.id.sms_text);
		v.setText(i.m);
		return new AlertDialog.Builder(this).setIcon(null).setTitle(R.string.sms_title).setView(mView).setPositiveButton(R.string.dialogConfirm,
					...
					public void onClick(DialogInterface dialog, int whichButton) {
						if (BaseActivity.this instanceof MainActivity) {
							...
							if (Global.app_status != Global.STARTED) {
								((MainActivity) BaseActivity.this).setView();
								((MainActivity) BaseActivity.this).addListener1();
